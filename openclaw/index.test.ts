...
Actual question here`;
  ...
  it("removes bare local attachment paths", () => {
    const input = "/Users/scorpion/Desktop/screenshot.png\nWhat changed here?";
    expect(stripNoiseFromContent(input)).toBe("What changed here?");
  });
